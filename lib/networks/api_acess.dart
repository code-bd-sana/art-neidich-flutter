...
import '../features/test_image/data/rx_post_multiple/rx.dart';
import '../features/test_image/data/rx_post_single/rx.dart';
...
MultipleImageRX multipleImageRXObj = MultipleImageRX(
  empty: {},
  dataFetcher: BehaviorSubject<Map>(),
);
